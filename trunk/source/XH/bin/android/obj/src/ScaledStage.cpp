...
{
HX_STACK_FRAME("ScaledStage","new",0x3bde1c96,"ScaledStage.new","ApplicationMain.hx",207,0x0780ded5)
HX_STACK_THIS(this)
...
int ScaledStage_obj::get___stageHeight( ){
	HX_STACK_FRAME("ScaledStage","get___stageHeight",0x9db8d432,"ScaledStage.get___stageHeight","ApplicationMain.hx",214,0x0780ded5)
	HX_STACK_THIS(this)
	HX_STACK_LINE(214)
...
int ScaledStage_obj::get___stageWidth( ){
	HX_STACK_FRAME("ScaledStage","get___stageWidth",0xb66b3c1b,"ScaledStage.get___stageWidth","ApplicationMain.hx",221,0x0780ded5)
	HX_STACK_THIS(this)
	HX_STACK_LINE(221)
...
int ScaledStage_obj::get_stageHeight( ){
	HX_STACK_FRAME("ScaledStage","get_stageHeight",0x948e0612,"ScaledStage.get_stageHeight","ApplicationMain.hx",228,0x0780ded5)
	HX_STACK_THIS(this)
	HX_STACK_LINE(228)
	return (int)960;
}
...
int ScaledStage_obj::get_stageWidth( ){
	HX_STACK_FRAME("ScaledStage","get_stageWidth",0x034ae63b,"ScaledStage.get_stageWidth","ApplicationMain.hx",234,0x0780ded5)
	HX_STACK_THIS(this)
	HX_STACK_LINE(234)
	return (int)540;
}
