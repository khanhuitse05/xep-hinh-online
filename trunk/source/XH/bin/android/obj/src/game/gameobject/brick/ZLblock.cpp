...
Void ZLblock_obj::__construct(int _x,int _y)
{
HX_STACK_FRAME("game.gameobject.brick.ZLblock","new",0x715a2ddf,"game.gameobject.brick.ZLblock.new","game/gameobject/brick/ZLblock.hx",12,0x8cb98b52)
HX_STACK_THIS(this)
HX_STACK_ARG(_x,"_x")
HX_STACK_ARG(_y,"_y")
{
	...
	HX_STACK_LINE(14)
	this->mType = ::game::gameobject::brick::BlockType_obj::ZL;
	HX_STACK_LINE(15)
	...
	HX_STACK_LINE(21)
	this->mData = Array_obj< ::Dynamic >::__new().Add(Array_obj< int >::__new().Add((int)1).Add((int)0)).Add(Array_obj< int >::__new().Add((int)1).Add((int)1)).Add(Array_obj< int >::__new().Add((int)0).Add((int)1));
	HX_STACK_LINE(28)
...
//ZLblock_obj::~ZLblock_obj() { }

Dynamic ZLblock_obj::__CreateEmpty() { return  new ZLblock_obj; }
hx::ObjectPtr< ZLblock_obj > ZLblock_obj::__new(int _x,int _y)
{  hx::ObjectPtr< ZLblock_obj > result = new ZLblock_obj();
	result->__construct(_x,_y);
	return result;}

Dynamic ZLblock_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< ZLblock_obj > result = new ZLblock_obj();
	result->__construct(inArgs[0],inArgs[1]);
	return result;}

Void ZLblock_obj::setDirect( int _direct){
{
		HX_STACK_FRAME("game.gameobject.brick.ZLblock","setDirect",0x02e1c72a,"game.gameobject.brick.ZLblock.setDirect","game/gameobject/brick/ZLblock.hx",47,0x8cb98b52)
		HX_STACK_THIS(this)
		...
		if (  ( _switch_1==::game::gameobject::brick::BlockDirect_obj::LEFT)){
			...
			if (((this->mDirect != ::game::gameobject::brick::BlockDirect_obj::RIGHT))){
				HX_STACK_LINE(52)
				this->mData = Array_obj< ::Dynamic >::__new().Add(Array_obj< int >::__new().Add((int)0).Add((int)1).Add((int)1)).Add(Array_obj< int >::__new().Add((int)1).Add((int)1).Add((int)0));
				HX_STACK_LINE(57)
				this->UpdateDirect();
			}
			HX_STACK_LINE(59)
...
Dynamic ZLblock_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic ZLblock_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	return super::__SetField(inName,inValue,inCallProp);
}

void ZLblock_obj::__GetFields(Array< ::String> &outFields)
{
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(ZLblock_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(ZLblock_obj::__mClass,"__mClass");
};

#endif

Class ZLblock_obj::__mClass;

void ZLblock_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("game.gameobject.brick.ZLblock"), hx::TCanCast< ZLblock_obj> ,sStaticFields,sMemberFields,
