...
HX_STACK_FRAME("sys.net.Host","__init__",0xecfcc384,"sys.net.Host.__init__","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Host.hx",46,0xf180fedc)
{
	HX_STACK_LINE(46)
...
::String Host_obj::toString( ){
	HX_STACK_FRAME("sys.net.Host","toString",0xe5efb6e0,"sys.net.Host.toString","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Host.hx",33,0xf180fedc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(34)
