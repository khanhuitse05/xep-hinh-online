...
HX_STACK_ARG(properties,"properties")
{
	...
	if ((::Std_obj::is(properties->__Field(HX_CSTRING("filter"),true),hx::ClassOf< ::Class >()))){
		...
		HX_STACK_LINE(31)
		{
			...
			HX_STACK_LINE(31)
			Dynamic _g1 = (hx::TCast< openfl::_v2::display::DisplayObject >::cast(target))->get_filters();		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(31)
			while((true)){
				HX_STACK_LINE(31)
		...
		HX_STACK_LINE(44)
		Dynamic _g = (hx::TCast< openfl::_v2::display::DisplayObject >::cast(target))->get_filters();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(44)
		::openfl::_v2::filters::BitmapFilter _g1 = _g->__GetItem(this->filterIndex);		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(44)
		this->filter = _g1;
	}
}
...
Void FilterActuator_obj::update( Float currentTime){
{
		...
		HX_STACK_LINE(97)
		Dynamic filters = (hx::TCast< openfl::_v2::display::DisplayObject >::cast(this->target))->get_filters();		HX_STACK_VAR(filters,"filters");
		HX_STACK_LINE(99)
...
Dynamic FilterActuator_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"filter") ) { filter=inValue.Cast< ::openfl::_v2::filters::BitmapFilter >(); return inValue; }
		break;
	case 11:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::_v2::filters::BitmapFilter*/ ,(int)offsetof(FilterActuator_obj,filter),HX_CSTRING("filter")},
