...
class HXCPP_CLASS_ATTRIBUTES  EffectsOptions_obj : public hx::Object{
	public:
		...
		EffectsOptions_obj();
		Void __construct(::openfl::_v2::display::DisplayObject target,Float duration,bool overwrite);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< EffectsOptions_obj > __new(::openfl::_v2::display::DisplayObject target,Float duration,bool overwrite);
		...
		Float duration;
		bool overwrite;
		::openfl::_v2::display::DisplayObject target;
