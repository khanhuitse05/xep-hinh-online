...
#define INCLUDED_openfl__v2_utils_ArrayBufferView
...
class HXCPP_CLASS_ATTRIBUTES  ArrayBufferView_obj : public hx::Object{
	...
	public:
		...
		inline operator ::openfl::_v2::utils::IMemoryRange_obj *()
			{ return new ::openfl::_v2::utils::IMemoryRange_delegate_< ArrayBufferView_obj >(this); }
		hx::Object *__ToInterface(const hx::type_info &inType);
		::String __ToString() const { return HX_CSTRING("ArrayBufferView"); }

		::openfl::_v2::utils::ByteArray buffer;
		int byteOffset;
		int byteLength;
...
#endif /* INCLUDED_openfl__v2_utils_ArrayBufferView */ 
