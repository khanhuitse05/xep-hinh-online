...
#define INCLUDED_openfl__v2_utils_IDataInput
...
virtual Void readBytes( ::openfl::_v2::utils::ByteArray data,hx::Null< int >  offset,hx::Null< int >  length)=0;
...
#define DELEGATE_openfl__v2_utils_IDataInput \
...
virtual Void readBytes( ::openfl::_v2::utils::ByteArray data,hx::Null< int >  offset,hx::Null< int >  length) { return mDelegate->readBytes(data,offset,length);}  \
...
class IDataInput_delegate_ : public IDataInput_obj
{
	...
	public:
		...
		DELEGATE_openfl__v2_utils_IDataInput
};
...
#endif /* INCLUDED_openfl__v2_utils_IDataInput */ 
