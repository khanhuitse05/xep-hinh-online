...
#define INCLUDED_openfl__v2_display_ManagedStage
...
class HXCPP_CLASS_ATTRIBUTES  ManagedStage_obj : public ::openfl::_v2::display::Stage_obj{
	public:
...
#endif /* INCLUDED_openfl__v2_display_ManagedStage */ 
