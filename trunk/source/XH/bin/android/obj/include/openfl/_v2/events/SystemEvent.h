...
#define INCLUDED_openfl__v2_events_SystemEvent
...
HX_DECLARE_CLASS3(openfl,_v2,events,SystemEvent)
namespace openfl{
namespace _v2{
namespace events{


class HXCPP_CLASS_ATTRIBUTES  SystemEvent_obj : public ::openfl::_v2::events::Event_obj{
	public:
...
#endif /* INCLUDED_openfl__v2_events_SystemEvent */ 
