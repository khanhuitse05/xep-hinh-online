...
#define INCLUDED_scene_loading_LoadFist
...
HX_DECLARE_CLASS2(scene,loading,LoadFist)
namespace scene{
namespace loading{


class HXCPP_CLASS_ATTRIBUTES  LoadFist_obj : public ::core::display::scene::SceneBase_obj{
	public:
		typedef ::core::display::scene::SceneBase_obj super;
		typedef LoadFist_obj OBJ_;
		LoadFist_obj();
	...
	public:
		...
		static hx::ObjectPtr< LoadFist_obj > __new(::core::display::scene::SceneID sceneID);
		...
		::String __ToString() const { return HX_CSTRING("LoadFist"); }
...
#endif /* INCLUDED_scene_loading_LoadFist */ 
