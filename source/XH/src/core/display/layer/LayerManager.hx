...
class LayerManager
{
	...
	public static inline var LAYER_INFO:Int = 3; 
	public static inline var LAYER_MESSAGE:Int = 4; 
	public static inline var LAYER_TOP:Int = 5; 
	public static inline var LAYER_COUNT:Int = 6; 
