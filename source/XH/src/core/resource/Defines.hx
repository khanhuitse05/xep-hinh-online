...
class Defines
{
	...
	inline public static var GFX_P_SIGLE_BG:Int 		= 3;
	inline public static var GFX_BATTLES_BG:Int 		= 4;
	inline public static var GFX_P_FRIEND_BG:Int 		= 5;
	inline public static var GFX_MISSION_BG:Int 		= 6;
	inline public static var GFX_BTN_SINGLE:Int 		= 7;
	inline public static var GFX_BTN_BATTLES:Int 		= 8;
	inline public static var GFX_BTN_FRIEND:Int 		= 9;
	inline public static var GFX_BTN_MISSION:Int 		= 10;
	...
	inline public static var GFX_ULTIMATE_FINISH:Int	= 37;
	inline public static var GFX_ULTIMATE_001:Int		= 38;
	...
	inline public static var MAX_BITMAP:Int = 4;	
	//
}