...
#define INCLUDED_openfl__v2_events_IEventDispatcher
...
virtual bool dispatchEvent( ::openfl::_v2::events::Event event)=0;
...
#define DELEGATE_openfl__v2_events_IEventDispatcher \
...
virtual bool dispatchEvent( ::openfl::_v2::events::Event event) { return mDelegate->dispatchEvent(event);}  \
...
class IEventDispatcher_delegate_ : public IEventDispatcher_obj
{
	...
	public:
		...
		DELEGATE_openfl__v2_events_IEventDispatcher
};
...
#endif /* INCLUDED_openfl__v2_events_IEventDispatcher */ 
