...
#define INCLUDED_openfl__v2_utils_ByteArray
...
class HXCPP_CLASS_ATTRIBUTES  ByteArray_obj : public ::haxe::io::Bytes_obj{
	...
	public:
		...
		inline operator ::openfl::_v2::utils::IMemoryRange_obj *()
			{ return new ::openfl::_v2::utils::IMemoryRange_delegate_< ByteArray_obj >(this); }
		inline operator ::openfl::_v2::utils::IDataOutput_obj *()
			{ return new ::openfl::_v2::utils::IDataOutput_delegate_< ByteArray_obj >(this); }
		inline operator ::openfl::_v2::utils::IDataInput_obj *()
			{ return new ::openfl::_v2::utils::IDataInput_delegate_< ByteArray_obj >(this); }
		...
		virtual Void compress( ::openfl::_v2::utils::CompressionAlgorithm algorithm);
		...
		virtual ::openfl::_v2::utils::ByteArray getByteBuffer( );
		...
		virtual Void readBytes( ::openfl::_v2::utils::ByteArray data,hx::Null< int >  offset,hx::Null< int >  length);
		...
		virtual ::openfl::_v2::utils::ByteArray slice( int begin,Dynamic end);
		Dynamic slice_dyn();

		virtual Void uncompress( ::openfl::_v2::utils::CompressionAlgorithm algorithm);
		...
		static ::openfl::_v2::utils::ByteArray fromBytes( ::haxe::io::Bytes bytes);
		static Dynamic fromBytes_dyn();

		static ::openfl::_v2::utils::ByteArray readFile( ::String path);
...
#endif /* INCLUDED_openfl__v2_utils_ByteArray */ 
