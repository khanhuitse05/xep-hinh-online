...
#define INCLUDED_openfl__v2_text_TextField
...
class HXCPP_CLASS_ATTRIBUTES  TextField_obj : public ::openfl::_v2::display::InteractiveObject_obj{
	public:
	...
	public:
		...
		virtual ::openfl::_v2::text::TextLineMetrics getLineMetrics( int lineIndex);
		Dynamic getLineMetrics_dyn();

		virtual ::openfl::_v2::text::TextFormat getTextFormat( hx::Null< int >  beginIndex,hx::Null< int >  endIndex);
		...
		virtual Void setTextFormat( ::openfl::_v2::text::TextFormat format,hx::Null< int >  beginIndex,hx::Null< int >  endIndex);
		...
		virtual ::openfl::_v2::text::TextFormat get_defaultTextFormat( );
		Dynamic get_defaultTextFormat_dyn();

		virtual ::openfl::_v2::text::TextFormat set_defaultTextFormat( ::openfl::_v2::text::TextFormat value);
...
#endif /* INCLUDED_openfl__v2_text_TextField */ 
