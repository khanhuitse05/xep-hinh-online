...
Void LRblock_obj::__construct(int _x,int _y)
{
HX_STACK_FRAME("game.gameobject.brick.LRblock","new",0xe6ef1f8b,"game.gameobject.brick.LRblock.new","game/gameobject/brick/LRblock.hx",12,0xfa4f7326)
HX_STACK_THIS(this)
HX_STACK_ARG(_x,"_x")
HX_STACK_ARG(_y,"_y")
{
	...
	HX_STACK_LINE(14)
	this->mType = ::game::gameobject::brick::BlockType_obj::LR;
	HX_STACK_LINE(15)
	...
	HX_STACK_LINE(22)
	this->mData = Array_obj< ::Dynamic >::__new().Add(Array_obj< int >::__new().Add((int)0).Add((int)1)).Add(Array_obj< int >::__new().Add((int)0).Add((int)1)).Add(Array_obj< int >::__new().Add((int)1).Add((int)1));
	HX_STACK_LINE(29)
...
//LRblock_obj::~LRblock_obj() { }

Dynamic LRblock_obj::__CreateEmpty() { return  new LRblock_obj; }
hx::ObjectPtr< LRblock_obj > LRblock_obj::__new(int _x,int _y)
{  hx::ObjectPtr< LRblock_obj > result = new LRblock_obj();
	result->__construct(_x,_y);
	return result;}

Dynamic LRblock_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< LRblock_obj > result = new LRblock_obj();
	result->__construct(inArgs[0],inArgs[1]);
	return result;}

Void LRblock_obj::setDirect( int _direct){
{
		HX_STACK_FRAME("game.gameobject.brick.LRblock","setDirect",0x84ad41d6,"game.gameobject.brick.LRblock.setDirect","game/gameobject/brick/LRblock.hx",48,0xfa4f7326)
		HX_STACK_THIS(this)
		...
		if (  ( _switch_1==::game::gameobject::brick::BlockDirect_obj::LEFT)){
			...
			HX_STACK_LINE(62)
			this->mData = Array_obj< ::Dynamic >::__new().Add(Array_obj< int >::__new().Add((int)1).Add((int)1)).Add(Array_obj< int >::__new().Add((int)1).Add((int)0)).Add(Array_obj< int >::__new().Add((int)1).Add((int)0));
			HX_STACK_LINE(68)
			this->UpdateDirect();
			HX_STACK_LINE(69)
			...
			HX_STACK_LINE(76)
			this->mData = Array_obj< ::Dynamic >::__new().Add(Array_obj< int >::__new().Add((int)1).Add((int)1).Add((int)1)).Add(Array_obj< int >::__new().Add((int)0).Add((int)0).Add((int)1));
			HX_STACK_LINE(81)
			this->UpdateDirect();
			HX_STACK_LINE(82)
			...
			HX_STACK_LINE(89)
			this->mData = Array_obj< ::Dynamic >::__new().Add(Array_obj< int >::__new().Add((int)1).Add((int)0).Add((int)0)).Add(Array_obj< int >::__new().Add((int)1).Add((int)1).Add((int)1));
			HX_STACK_LINE(94)
			this->UpdateDirect();
			HX_STACK_LINE(95)
...
Dynamic LRblock_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic LRblock_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	return super::__SetField(inName,inValue,inCallProp);
}

void LRblock_obj::__GetFields(Array< ::String> &outFields)
{
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(LRblock_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(LRblock_obj::__mClass,"__mClass");
};

#endif

Class LRblock_obj::__mClass;

void LRblock_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("game.gameobject.brick.LRblock"), hx::TCanCast< LRblock_obj> ,sStaticFields,sMemberFields,
