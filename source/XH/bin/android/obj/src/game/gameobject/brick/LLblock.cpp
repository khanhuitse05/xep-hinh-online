...
Void LLblock_obj::__construct(int _x,int _y)
{
HX_STACK_FRAME("game.gameobject.brick.LLblock","new",0x65305051,"game.gameobject.brick.LLblock.new","game/gameobject/brick/LLblock.hx",12,0x08a6fd20)
HX_STACK_THIS(this)
HX_STACK_ARG(_x,"_x")
HX_STACK_ARG(_y,"_y")
{
	...
	HX_STACK_LINE(14)
	this->mType = ::game::gameobject::brick::BlockType_obj::LL;
	HX_STACK_LINE(15)
	...
	HX_STACK_LINE(22)
	this->mData = Array_obj< ::Dynamic >::__new().Add(Array_obj< int >::__new().Add((int)1).Add((int)1)).Add(Array_obj< int >::__new().Add((int)0).Add((int)1)).Add(Array_obj< int >::__new().Add((int)0).Add((int)1));
	HX_STACK_LINE(29)
...
//LLblock_obj::~LLblock_obj() { }

Dynamic LLblock_obj::__CreateEmpty() { return  new LLblock_obj; }
hx::ObjectPtr< LLblock_obj > LLblock_obj::__new(int _x,int _y)
{  hx::ObjectPtr< LLblock_obj > result = new LLblock_obj();
	result->__construct(_x,_y);
	return result;}

Dynamic LLblock_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< LLblock_obj > result = new LLblock_obj();
	result->__construct(inArgs[0],inArgs[1]);
	return result;}

Void LLblock_obj::setDirect( int _direct){
{
		HX_STACK_FRAME("game.gameobject.brick.LLblock","setDirect",0xd98c4b1c,"game.gameobject.brick.LLblock.setDirect","game/gameobject/brick/LLblock.hx",48,0x08a6fd20)
		HX_STACK_THIS(this)
		...
		if (  ( _switch_1==::game::gameobject::brick::BlockDirect_obj::LEFT)){
			...
			HX_STACK_LINE(62)
			this->mData = Array_obj< ::Dynamic >::__new().Add(Array_obj< int >::__new().Add((int)1).Add((int)0)).Add(Array_obj< int >::__new().Add((int)1).Add((int)0)).Add(Array_obj< int >::__new().Add((int)1).Add((int)1));
			HX_STACK_LINE(68)
			this->UpdateDirect();
			HX_STACK_LINE(69)
			...
			HX_STACK_LINE(76)
			this->mData = Array_obj< ::Dynamic >::__new().Add(Array_obj< int >::__new().Add((int)1).Add((int)1).Add((int)1)).Add(Array_obj< int >::__new().Add((int)1).Add((int)0).Add((int)0));
			HX_STACK_LINE(81)
			this->UpdateDirect();
			HX_STACK_LINE(82)
			...
			HX_STACK_LINE(89)
			this->mData = Array_obj< ::Dynamic >::__new().Add(Array_obj< int >::__new().Add((int)0).Add((int)0).Add((int)1)).Add(Array_obj< int >::__new().Add((int)1).Add((int)1).Add((int)1));
			HX_STACK_LINE(94)
			this->UpdateDirect();
			HX_STACK_LINE(95)
...
Dynamic LLblock_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic LLblock_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	return super::__SetField(inName,inValue,inCallProp);
}

void LLblock_obj::__GetFields(Array< ::String> &outFields)
{
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(LLblock_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(LLblock_obj::__mClass,"__mClass");
};

#endif

Class LLblock_obj::__mClass;

void LLblock_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("game.gameobject.brick.LLblock"), hx::TCanCast< LLblock_obj> ,sStaticFields,sMemberFields,
