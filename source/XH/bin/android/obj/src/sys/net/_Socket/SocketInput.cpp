...
int SocketInput_obj::readBytes( ::haxe::io::Bytes buf,int pos,int len){
	HX_STACK_FRAME("sys.net._Socket.SocketInput","readBytes",0x9fb565d0,"sys.net._Socket.SocketInput.readBytes","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",47,0xa375f0f1)
	HX_STACK_THIS(this)
