...
::openfl::_v2::events::Event SecurityErrorEvent_obj::clone( ){
...
Dynamic SecurityErrorEvent_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 8:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"SECURITY_ERROR") ) { return SECURITY_ERROR; }
	}
...
Dynamic SecurityErrorEvent_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 14:
		if (HX_FIELD_EQ(inName,"SECURITY_ERROR") ) { SECURITY_ERROR=inValue.Cast< ::String >(); return inValue; }
	}
